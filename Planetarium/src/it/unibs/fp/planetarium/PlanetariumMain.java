        ...
        do {
            ...
            case 3:
                ...
                if (pianetaDaEliminare != null) {
                	...
                	System.out.println("Il pianeta " + pianetaDaEliminareString + " � stato eliminato correttamente");
                		}else {
            ...
            case 4:
                ...
                if (lunaDaEliminare != null) {
                	...
                	System.out.println("Il satellite " + lunaDaEliminareString + " � stato eliminato correttamente");
                		}else {
